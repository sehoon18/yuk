                                ...
                                <div class="row">
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="instructionCode" class="form-control" placeholder="INS0000" name="instructionCode">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="last-name-column">수주코드</label>
                                            <input type="text" id="contractCode" class="form-control" onclick="openPopup()" placeholder="CON0000" name="lname-column">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="city-column">품목코드</label>
                                            <input type="text" id="productCode" class="form-control" placeholder="PRO0000" name="productCode">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="country-floating">수량</label>
                                            <input type="text" id="insVol" class="form-control" name="insVol" placeholder="000">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="company-column">품명</label>
                                            <input type="text" id="productName" class="form-control" name="productName" placeholder="PRODUCT">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
                                            <label for="email-id-column">라인코드</label>
                                            <input type="text" id="lineCode" class="form-control" name="email-id-column" onclick="openLinePopup()" placeholder="L0000">
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-12">
                                        <div class="form-group">
