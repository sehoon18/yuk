...
<button class="btn btn-primary btn-sm" type="submit">저장</button>
     ...
     <script>
	  // 인풋 창을 클릭하면 팝업을 엽니다.
	  function popup() {
	    var popup = window.open("${pageContext.request.contextPath}/ordercontract/orderdeletepopup", "popup", "width=1600,height=600");
	...
	<script>
	  // 인풋 창을 클릭하면 팝업을 엽니다.
	  function addpopup() {
	    var popup = window.open("${pageContext.request.contextPath}/ordercontract/orderaddpopup", "addpopup", "width=1600,height=600");
