    ...
    <ul class="pagination pagination-primary justify-content-end">
        ...
        <c:forEach var="i" begin="${pageDTO.startPage}" end="${pageDTO.endPage}" step="1">
            <li class="page-item ${pageDTO.currentPage == i ? 'active' : ''}">
                <a class="page-link" href="${pageContext.request.contextPath}/warehouse/stockCodePopup?pageNum=${i}&productCode=${pageDTO.productCode}&productName=${pageDTO.productName}&warehouseName=${pageDTO.warehouseName}&productType=${pageDTO.productType}">${i}</a>
            </li>
        </c:forEach>
        <c:if test="${pageDTO.endPage < pageDTO.pageCount}">
            <li class="page-item">
                <a class="page-link" href="${pageContext.request.contextPath}/warehouse/stockCodePopup?pageNum=${pageDTO.endPage + 1}&productCode=${pageDTO.productCode}&productName=${pageDTO.productName}&warehouseName=${pageDTO.warehouseName}&productType=${pageDTO.productType}"><span aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg></span></a>
            </li>
        </c:if>
        <c:if test="${pageDTO.endPage >= pageDTO.pageCount}">
            <li class="page-item disabled">
